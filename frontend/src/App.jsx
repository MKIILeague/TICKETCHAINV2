...
import { Ticket as TicketIcon, Wallet, LogIn, LogOut, Building2 } from "lucide-react";
    ...
    <header className="sticky top-0 z-50 bg-white/85 backdrop-blur-md border-b border-slate-200">
      <nav className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between gap-4">
        <NavLink to="/" className="flex items-center gap-2.5 shrink-0">
          ...
          <span className="font-bold text-slate-900 tracking-tight text-base hidden sm:block">TicketChain</span>
        </NavLink>
